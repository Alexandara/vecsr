...
inside([[toothpaste63, bathroom11], [faucet51, bathroom11], [toothbrush66, bathroom11]]).
ontopof([[toothbrush66, bathroomcounter50], [toothpaste63, bathroomcounter50], [faucet51, bathroomcounter50]]).
rooms(bathroom11).
type(vacuum0, vacuum).
has_switch(vacuum0).
grabbable(vacuum0).
