...
type(clothesshirt4, clothesshirt).
grabbable(clothesshirt4).
type(clothesshirt5, clothesshirt).
grabbable(clothesshirt5).
inside([inside(character0, livingroom100), inside(remotecontrol1, livingroom100), inside(television2, livingroom100), inside(clothesbasket3, livingroom100), inside(clothesshirt4, livingroom100), inside(clothesshirt5, livingroom100)]).
inside_character([livingroom100]).
% Rules
% Constraints
% Helper functions
member(X,[X|_]).
